...
x_ticks_1750 = pd.date_range(start='1750', end='2026', freq='25Y')
x_ticks_1961 = pd.date_range(start='1960', end='2026', freq='5Y')
...
fig.savefig("Trends_in_temperature_precipitation_and_maize_yield_in_East_Africa.png", dpi=300, bbox_inches='tight')
